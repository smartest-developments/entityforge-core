...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Diagnose MVP/Senzing runtime failures")
    parser.add_argument(
        "--runtime-dir",
        default=None,
    ...
    parser.add_argument(
        ...
        help="Output directory for reports (default: output/diagnostics under MVP root).",
    )
    parser.add_argument(
        "--max-tail-lines",
        type=int,
...
def render_markdown(payload: dict[str, Any]) -> str:
    ...
    lines: list[str] = []
    lines.append("# MVP Runtime Diagnostic Report")
    lines.append("")
