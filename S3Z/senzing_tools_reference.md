...
{
  "mode": "local",
  "senzingEnv": "/path/to/S3Z/project/setupEnv",
  "docker_container": "senzing-tools",
  "docker_data_dir": "/data",
  "ssh_host": "user@remote-server",
  "ssh_data_dir": "/home/S3Z/data"
}
```
...
{
  "mode": "local",
  "senzingEnv": "/home/user/S3Z/project/setupEnv"
}
```
...
```json
{
  ...
  "ssh_data_dir": "/home/S3Z/data",
  "senzingEnv": "/home/S3Z/project/setupEnv"
}
```
...
- Files must always be transferred via `scp` before use:
  scp output.jsonl senzing@host:/home/S3Z/data/
...
**Command:**
python3 S3Z/tools/sz_schema_generator.py <input_file> -o <source_filename>_schema.md
...
**Example:**
python3 S3Z/tools/sz_schema_generator.py customers.csv -o customers_schema.md
...
**Command:**
python3 S3Z/tools/lint_senzing_json.py <file.jsonl>
...
**Command:**
python3 S3Z/tools/sz_json_analyzer.py <input.jsonl> -o <analysis>.md
...
save
EOF
source /home/user/S3Z/project/setupEnv && sz_configtool -f customers_config.g2c
...
1. Analyze source data
   python3 S3Z/tools/sz_schema_generator.py source.csv -o source_schema.md
...
4. Analyze mapping quality on complete dataset
   python3 S3Z/tools/sz_json_analyzer.py output.jsonl -o analysis.md
