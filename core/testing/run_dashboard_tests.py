#!/usr/bin/env python3
"""Run core dashboard validation suite and emit machine/human reports."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run automated tests for core dashboard metric correctness")
    parser.add_argument("--output-root", default="output", help="core output root directory (default: output)")
    parser.add_argument(
        "--dashboard-data",
