#!/usr/bin/env python3
"""Run core pipeline for one or more sample inputs in a directory."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run core pipeline for sample JSON/JSONL inputs")
...
def run_one(
    ...
    command = [
        sys.executable,
        str(app_root / "run_mvp_pipeline.py"),
        "--input-json",
        str(sample_path),
        "--execution-mode",
        execution_mode,
