#!/usr/bin/env python3
"""Generate one stress sample (default 1,000,000 rows) for core as source-style JSONL.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate one stress sample JSONL for core")
    ...
    parser.add_argument("--sample-dir", default="sample_input", help="Target sample directory under core")
...
def generate_one_sample(
    ...
    stats["notes"] = [
        ...
        "Use with core/app/run_mvp_pipeline.py directly on JSONL input.",
    ]
